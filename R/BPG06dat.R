#' Simulated dataset from Bauer, Preacher, and Gil (2006)
#'
#' In supplementary materials, Bauer, Preacher, and Gil (2006) provide a simulated dataset in SAS format.
#' That dataset is replicated here.
#'
#' @format A data frame with 800 observations (from 100 subjects) and 4 variables
#' \describe{
#'   \item{id}{Level 2 or subject ID}
#'   \item{x}{Predictor}
#'   \item{m}{Mediator}
#'   \item{y}{Outcome}
#' }
